...
2. Swap out the `badgen.net` in the URL with `gradgen.boris.sh`
...
| With gradient                       | `https://gradgen.boris.sh/github/checks/nodejs/node?gradient=red,yellow`               |                           [![With gradient][gradient]][gradient]                           |
| Flat badge                          | `https://gradgen.boris.sh/github/checks/nodejs/node?gradient=b65cff,11cbfa&style=flat` |                                [![Flat badge][flat]][flat]                                 |

[original]: https://badgen.net/github/checks/nodejs/node
[gradient]: https://gradgen.boris.sh/github/checks/nodejs/node?gradient=red,yellow
[flat]: https://gradgen.boris.sh/github/checks/nodejs/node?gradient=b65cff,11cbfa&style=flat
