...
Gradgen is a very simple Cloudflare worker that adds gradients to badges generated by [badgen.net](https://badgen.net/help#generators)
...
| With gradient      | `https://gradgen.bokub.workers.dev/github/checks/nodejs/node?gradient=red,yellow`               | ![Original badge](https://gradgen.bokub.workers.dev/github/checks/nodejs/node?gradient=red,F78642)               |
| Flat with gradient | `https://gradgen.bokub.workers.dev/github/checks/nodejs/node?gradient=b65cff,11cbfa&style=flat` | ![Original badge](https://gradgen.bokub.workers.dev/github/checks/nodejs/node?gradient=b65cff,11cbfa&style=flat) |
